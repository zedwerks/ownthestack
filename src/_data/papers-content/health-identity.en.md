...
related: [sovereignty-risk, open-source-foundations, landscape-analysis, architecture]
---
...
## A Canadian Health Identity and Clinical Platform
...
* that they are covered by a Canadian public health plan;
* which jurisdiction is responsible for their coverage;
* the identifier required for registration or billing;
* whether that coverage is currently valid; and
* only the additional information required for the transaction at hand.
...
* patient registration and identity matching;
* proof of provincial or territorial coverage;
* interprovincial reciprocal billing;
* consent and delegated authority;
* clinical documentation;
* orders, results and referrals;
